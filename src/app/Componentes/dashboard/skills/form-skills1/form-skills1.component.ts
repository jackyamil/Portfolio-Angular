...
@Component({
  selector: 'app-form-skills1',
  templateUrl: './form-skills1.component.html',
  styleUrls: ['./form-skills1.component.css']
})
export class FormSkills1Component implements OnInit{
  form: FormGroup;
