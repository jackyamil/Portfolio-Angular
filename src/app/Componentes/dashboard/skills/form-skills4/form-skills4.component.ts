...
@Component({
  selector: 'app-form-skills4',
  templateUrl: './form-skills4.component.html',
  styleUrls: ['./form-skills4.component.css']
})
export class FormSkills4Component implements OnInit{
  form: FormGroup;
