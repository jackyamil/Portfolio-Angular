...
@Component({
  selector: 'app-form-secundaria',
  templateUrl: './form-secundaria.component.html',
  styleUrls: ['./form-secundaria.component.css']
})
export class FormSecundariaComponent  implements OnInit{
  form: FormGroup;
