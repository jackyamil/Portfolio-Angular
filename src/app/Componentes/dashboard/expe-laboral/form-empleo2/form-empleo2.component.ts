...
@Component({
  selector: 'app-form-empleo2',
  templateUrl: './form-empleo2.component.html',
  styleUrls: ['./form-empleo2.component.css']
})
export class FormEmpleo2Component implements OnInit{
  form: FormGroup;
